 ...
 */
public class Notes extends ActionBarActivity implements AdapterView.OnItemClickListener,
...
//"COG/ALLFILES/Files/Notes"
        // Initialize local file path and backup file path
        localPath = new File(getFilesDir() + File.separator + NOTES_FILE_NAME);
