...
import org.schabi.cog.ActivityCommunicator;
import org.schabi.cog.VideoItemDetailActivity;
import org.schabi.cog.VideoItemDetailFragment;
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if(action.equals(ACTION_PLAYPAUSE)) {
                    if(mediaPlayer.isPlaying()) {
                        mediaPlayer.pause();
                        note.contentView.setImageViewResource(R.id.notificationPlayPause, R.drawable.play_circle);
                        if(android.os.Build.VERSION.SDK_INT >=16){
                            note.bigContentView.setImageViewResource(R.id.notificationPlayPause, R.drawable.play_transcircle);
                        }
                        ...
                        mediaPlayer.start();
                        note.contentView.setImageViewResource(R.id.notificationPlayPause, R.drawable.pause);
                        if(android.os.Build.VERSION.SDK_INT >=16){
                            note.bigContentView.setImageViewResource(R.id.notificationPlayPause, R.drawable.pause);
                        }
                        noteMgr.notify(noteID, note);
                    }
                }
