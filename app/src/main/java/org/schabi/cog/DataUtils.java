...
import static org.schabi.cog.Notes.getBackupPath;
import static org.schabi.cog.Notes.getLocalPath;
...
public class DataUtils {
    ...
    public static final String BACKUP_FOLDER_PATH = "/COG"; // Backup folder path
    public static final String BACKUP_FILE_NAME = "cityofgod_backup.json"; // Backup file name
